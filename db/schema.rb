...
ActiveRecord::Schema.define(version: 2022_11_03_060732) do
  ...
  create_table "areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["history_id"], name: "index_areas_on_history_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "name_furi", null: false
    t.string "name_gana", null: false
  ...
  add_foreign_key "areas", "histories"
